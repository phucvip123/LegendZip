                    ...
                    if (secondsPass < Manager.SECOND_WAIT_LOGIN) {
                        ...
                        if (!rs.first()) {
                            ...
                            if (dataArray.size() == 18) {
                                player.firstJoinBDKB = Boolean.parseBoolean(String.valueOf(dataArray.get(13)));
                                player.countBDKB = Byte.parseByte(String.valueOf(dataArray.get(14)));
                                player.lastimeJoinBDKB = Long.parseLong(String.valueOf(dataArray.get(15)));
