    ...
    public static void updatePlayer(Player player) {
        if (player.iDMark.isLoadedAllDataPlayer()) {
            ...
            try {
                ...
                dataArray.add(hp);
                dataArray.add(mp);
                dataArray.add(player.firstJoinBDKB);
                dataArray.add(player.countBDKB);
                dataArray.add(player.lastimeJoinBDKB);
                ...
                String query = " update player set khi_gas =?, data_item_time_sieu_cap = ?,head = ?, have_tennis_space_ship = ?,"
