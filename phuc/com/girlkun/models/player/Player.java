...
//                    KhiGasService.gI().update(this);
    ...
    private static final short[][] idOutfitFusion = {
        ...
        {2057, 2058, 2059}, {2051, 2052, 2053}, {2063, 2064, 2065},
        {2045, 2046, 2047}, {2060, 2061, 2062}, {2054, 2055, 2056},};
...
//                }
    ...
    public byte getAura() {
        ...
        if (item.template.id == 1138) {
            return 4;
        } else if (item.template.id == 1139) {
            return 10;
        } else if (item.template.id == 1140) {
            return 15;
        } else if (item.template.id == 1136) {
            return 14;
        } else {
            return -1;
        }
