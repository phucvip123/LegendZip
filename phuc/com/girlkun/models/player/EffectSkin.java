...
public class EffectSkin {
    ...
    private static final String[] textHoaDa = new String[]{
        "Á đụ má", "Tránh ra đi thằng đầu buồi", "Bị hóa đá ròi",
        "Kinh tởm quá", "Biến đi thằng lồn", "Kính ngài nước dãi"
    };
            ...
            if (CoCaiTrangHoaDa) {
                ...
                if (Check) { // thời gian hóa đá mỗi lần
                    ...
                    for (Player pl : players) {
                        ...
                        ItemTimeService.gI().sendItemTime(pl, 4392, (int) TIME_HOA_DA);
...
//                        System.err.println("HOA DA THANH CONG PLAYER: " + pl.name);
            ...
            if (this.player.nPoint.IsBiHoaDa && (System.currentTimeMillis() - lastTimeBiHoaDa > TIME_HOA_DA)) {
                ...
                Service.gI().chat(this.player, "Địt mẹ hết hóa đá rồi");
            }
        } catch (Exception e) {
            Logger.error("");
        }
