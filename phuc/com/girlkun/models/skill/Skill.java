...
public class Skill {
    ...
    public boolean IsSkillDam(int id){
        return (id == DEMON || id == LIEN_HOAN || id == GALICK  || id == DRAGON);
    }
    
    public boolean IsSkillChuong(int id){
        return (id == MASENKO || id == KAMEJOKO || id == ANTOMIC);
    }
}
