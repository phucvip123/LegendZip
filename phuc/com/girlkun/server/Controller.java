...
//                        System.err.println("KHANG TDHS : " + player.nPoint.khangTDHS);
//                        System.err.println("(System.currentTimeMillis() - lastTimeBiHoaDa: " + (System.currentTimeMillis() - player.effectSkin.lastTimeBiHoaDa);
                    }
                    break;
                case 32:
                    if (player != null) {
    ...
    public void sendInfo(MySession session) {
        ...
        if (TaskService.gI().getIdTask(player) == ConstTask.TASK_0_0) {
            NpcService.gI().createTutorial(player, -1,
                    "Chào mừng " + player.name + " đến với ngọc rồng online server Arriety\n"
