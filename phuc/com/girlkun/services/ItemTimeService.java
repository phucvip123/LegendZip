...
public class ItemTimeService {
    ...
    public void sendTextBanDoKhoBau(Player player) {
        if (player.clan != null
                && player.clan.lastTimeOpenBDKB != 0) {
            int secondPassed = (int) ((System.currentTimeMillis() - player.clan.lastTimeOpenBDKB) / 1000);
            int secondsLeft = (BanDo.TIME_BAN_DO / 1000) - secondPassed;
