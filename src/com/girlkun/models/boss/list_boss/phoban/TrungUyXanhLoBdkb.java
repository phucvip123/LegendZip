...
public class TrungUyXanhLoBdkb extends Boss {
    ...
    private double dameClan;
    private double hpClan;
    
    public TrungUyXanhLoBdkb(double dame, double hp, Zone zone) throws Exception {
        super(BossID.TRUNG_UY_XANH_LO_BDKB, TRUNG_UY_XANH_LO);
        this.dameClan = dame;
        this.hpClan = hp;
        this.zoneFinal = zone;
    }
    public TrungUyXanhLoBdkb(Zone zone,int level) throws Exception {
        super(BossID.TRUNG_UY_XANH_LO_BDKB, TRUNG_UY_XANH_LO);
        this.hpClan = 10000000*level;
        this.dameClan = 50000*level;
        this.zoneFinal = zone;
    }
