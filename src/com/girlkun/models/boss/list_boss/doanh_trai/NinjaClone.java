 ...
 */
 public class NinjaClone extends TrungUyTrang {
    ...
    public NinjaClone(NinjaAoTim TrueNinja, int x, int y, int idBoss, double dame, double hp, Zone zone) throws Exception {
    ...
    public void reward(Player plKill) {
        if (Util.isTrue(50, 100)) {
            ...
            for (Byte i = 0; i < 5; i++) {
                it = new ItemMap(this.zone, 20, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x,
                        this.location.y - 24), plKill.id);
            }
