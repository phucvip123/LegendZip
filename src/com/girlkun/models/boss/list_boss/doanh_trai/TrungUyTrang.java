...
public class TrungUyTrang extends Boss {
    ...
    public TrungUyTrang(double dame, double hp, Zone zone) throws Exception {
    ...
    public TrungUyTrang(double dame, double hp, Zone zone, int id, BossData... data) throws Exception {
        super(id, data);
        this.dameClan = dame;
        this.hpClan = hp;
        this.zoneFinal = zone;
