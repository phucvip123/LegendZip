...
public class CoolerGold extends Boss {
    ...
    public void reward(Player plKill) {
        ...
        Service.gI().dropItemMap(this.zone, new ItemMap(zone, 1084 + Util.nextInt(0, 2), 1, this.location.x, zone.map.yPhysicInTop(this.location.x, this.location.y - 24), plKill.id));
