...
//**************************************************************************
    ...
    public static final BossData NGAI_DEM = new BossData(
            "Ngài đêm", //name
            ConstPlayer.XAYDA, //gender
            new short[]{1393, 1394, 1395, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
            new double[]{500}, //hp
            new int[]{27,28}, //map join
