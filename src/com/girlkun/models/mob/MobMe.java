...
public final class MobMe extends Mob {
    ...
    public MobMe(Player player) {
        ...
        this.point.maxHp = Util.maxInt(SkillUtil.getHPMobMe(player.nPoint.hpMax, level));
        this.point.dame = Util.maxInt(SkillUtil.getHPMobMe(player.nPoint.getDameAttack(false), level));
