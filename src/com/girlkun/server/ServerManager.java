        ...
        new Thread(() -> {
             while (isRunning) {
                try {
                    ...
                    Player player = null;
                    for (int i = 0; i < Client.gI().getPlayers().size(); ++i) { //auto save
        ...
        new Thread(() -> {
            ...
            while (true) {
                ...
                if (line.equals("baotri")) {
                    ...
                    ServerNotify.gI().notify("Nro Legend debug server: " + Thread.activeCount());
