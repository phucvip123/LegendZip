...
public class ItemTimeService {
    ...
    public void sendAllItemTime(Player player) {
        ...
        if (player.itemTime.isdkhi) {
            sendItemTime(player, player.itemTime.icondkhi, (int) ((TIME_DUOI_KHI - (System.currentTimeMillis() - player.itemTime.lastTimedkhi)) / 1000));
        }
...
//    }
    ...
    public void sendTextKhiGas(Player player) {
        Service.gI().sendThongBao(player, "Khí gas");
    }
