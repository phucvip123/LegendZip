...
public class PlayerService {
    ...
    public void sendInfoMp(Player player) {
        ...
        try {
            ...
            msg.writer().writeInt(Util.maxInt(player.nPoint.mp));
            player.sendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
            Logger.logException(PlayerService.class, e);
    ...
    public void sendInfoHpMpMoney(Player player) {
        ...
        try {
            ...
            msg.writer().writeInt(Util.maxInt(player.nPoint.hp));//chp
            msg.writer().writeInt(Util.maxInt(player.nPoint.mp));//cmp
