...
//            e.printStackTrace();
    ...
    public void Send_Info_NV(Player pl) {
        ...
        try {
            ...
            msg.writer().writeInt((int) pl.id);
            msg.writer().writeInt(Util.maxInt(pl.nPoint.hp));
            msg.writer().writeByte(0);//Hiệu ứng Ăn Đậu
            msg.writer().writeInt(Util.maxInt(pl.nPoint.hpMax));
...
//            Service.gI().Send_Caitrang(player);
    ...
    public void point(Player player) {
        ...
        if (!player.isPet && !player.isBoss && !player.isNewPet) {
            ...
            try {
                msg = new Message(-42);
                msg.writer().writeInt(Util.maxInt(player.nPoint.hpg));
                msg.writer().writeInt(Util.maxInt(player.nPoint.mpg));
                msg.writer().writeInt(Util.maxInt(player.nPoint.dameg));
                msg.writer().writeInt(Util.maxInt(player.nPoint.hpMax));// hp full
                msg.writer().writeInt(Util.maxInt(player.nPoint.mpMax));// mp full
                msg.writer().writeInt(Util.maxInt(player.nPoint.hp));// hp
                msg.writer().writeInt(Util.maxInt(player.nPoint.mp));// mp
                msg.writer().writeByte(player.nPoint.speed);// speed
                msg.writer().writeByte(20);
                msg.writer().writeByte(20);
                msg.writer().writeByte(1);
                msg.writer().writeInt(Util.maxInt(player.nPoint.dame));// dam base
                msg.writer().writeInt(Util.maxInt(player.nPoint.def));// def full
                msg.writer().writeByte(player.nPoint.crit);// crit full
                msg.writer().writeLong(player.nPoint.tiemNang);
                msg.writer().writeShort(100);
                msg.writer().writeShort(Util.maxInt(player.nPoint.defg));
...
//    }
    ...
    public void hsChar(Player pl, double hp, double mp) {
        ...
        try {
            ...
            msg.writer().writeInt((int) pl.id);
            msg.writer().writeInt(Util.maxInt(hp));
            msg.writer().writeInt(Util.maxInt(mp));
            msg.writer().writeShort(pl.location.x);
            msg.writer().writeShort(pl.location.y);
...
//            e.printStackTrace();
    ...
    public void chooseFlag(Player pl, int index) {
        if (MapService.gI().isMapBlackBallWar(pl.zone.map.mapId) || MapService.gI().isMapMaBu(pl.zone.map.mapId) || MapService.gI().isMapPVP(pl.zone.map.mapId) || MapService.gI().isnguhs(pl.zone.map.mapId)) {
    ...
    public void showInfoPet(Player pl) {
        if (pl != null && pl.pet != null) {
            ...
            try {
                ...
                msg.writer().writeInt(Util.maxInt(pl.pet.nPoint.hp)); //hp
                msg.writer().writeInt(Util.maxInt(pl.pet.nPoint.hpMax)); //hpfull
                msg.writer().writeInt(Util.maxInt(pl.pet.nPoint.mp)); //mp
                msg.writer().writeInt(Util.maxInt(pl.pet.nPoint.mpMax)); //mpfull
                msg.writer().writeInt(Util.maxInt(pl.pet.nPoint.dame)); //damefull
                ...
                msg.writer().writeShort(Util.maxInt(pl.pet.nPoint.def)); //def
