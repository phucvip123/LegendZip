        ...
        if (itemAdd.template.isUpToUp) {
            for (Item it : items) {
                ...
                if (itemAdd.template.id == 457
                        ...
                        || itemAdd.template.type == 1236
                        || itemAdd.template.type == 1237
                        || itemAdd.template.type == 1238
                        || itemAdd.template.type == 1239
                        || itemAdd.template.type == 1240
                        || itemAdd.template.type == 1241
                        || itemAdd.template.type == 1144) {
